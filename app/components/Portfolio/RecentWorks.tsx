...
const RecentWorks = () => {
  return (
    <section id="recentWorks" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className={`text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed ${merriWeatherMedium.className}`}>
            Take a look at my latest book cover designs, featuring fresh concepts 
            and innovative approaches to visual storytelling.
          </p>
